...
function RouteComponent() {
  ...
  const { data: regencyCommodities, isLoading } =
    useQuery(
        ...
        <CardContent>
          {(() => {
            if (isLoading) {
              return (
                <p>
                  Loading regency commodity...
                </p>
              );
            }

            if (
              regencyCommoditiesList.length === 0
            ) {
              return (
