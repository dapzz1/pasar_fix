...
export const updateSalesRealization =
  protectedProcedure
    .input(SalesRealizationSchema)
    .handler(async ({ input, context }) => {
      try {
        const [updatedSalesRealization] =
          await context.db
            ...
            .set({
              ...
              realizationDaily:
                input.realizationDaily,

              month: input.month,

              realizationMonthly:
                input.realizationMonthly,

              rkapMonthly:
                input.rkapMonthly,

              realizationYtd:
                input.realizationYtd,
